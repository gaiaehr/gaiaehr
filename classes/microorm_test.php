...
$db->setField('active', 'TINYINT', 1, 0, false, false);
...
$db->setField('service_location', 'TINYINT', 1, 0, false, false);
$db->setField('billing_location', 'TINYINT', 1, 0, false, false);
$db->setField('accepts_assignment', 'TINYINT', 1, 0, false, false);
...
$db->setField('tax_id_type', 'VARCHAR', 31, 0, false, false);
