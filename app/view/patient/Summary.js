                        ...
                        items:[
                            {
                                ...
                                handler:function(){
                                    ...
                                    me.reportPanel.add(me.miframe = Ext.create('App.ux.ManagedIframe',{
                                        src: globals.url+'/dataProvider/documentCCRCCD.php?action=viewccr&raw=no&pid=' + me.pid
                                    }));
                            ...
                            },
                            {
                                ...
                                handler:function(){
                                    me.reportPanel.remove(me.miframe);
                                    me.reportPanel.add(me.miframe = Ext.create('App.ux.ManagedIframe',{
                                        src: globals.url+'/dataProvider/documentCCRCCD.php?action=viewccd&pid=' + me.pid
                                    }));
                                    // GAIAEH-177 GAIAEH-173 170.302.r Audit Log (core)
                        ...
                        items:[
                            {
                                ...
                                handler:function(){
                                    me.reportPanel.remove(me.miframe);
                                    me.reportPanel.add(me.miframe = Ext.create('App.ux.ManagedIframe',{
                                        src: globals.url+'/dataProvider/documentCCRCCD.php?action=generate&raw=yes&pid=' + me.pid
                                    }));
                                    // GAIAEH-177 GAIAEH-173 170.302.r Audit Log (core)
                            ...
                            },
                            {
                                ...
                                handler:function(){
                                    me.reportPanel.remove(me.miframe);
                                    me.reportPanel.add(me.miframe = Ext.create('App.ux.ManagedIframe',{
                                        src: globals.url+'/dataProvider/documentCCRCCD.php?action=viewccd&raw=yes&pid=' + me.pid
                                    }));
                                    // GAIAEH-177 GAIAEH-173 170.302.r Audit Log (core)
