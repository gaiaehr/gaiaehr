/**
 * @class App.ux.data.proxy.WebSocket
 * @author Vincenzo Ferrari <wilk3ert@gmail.com>
 *
 * HTML5 WebSocket proxy
 *
 * <h1>How it works?</h1>
 * App.ux.data.proxy.WebSocket provides an interface between stores and readers/writers.
 ...
 */
Ext.define('App.ux.data.proxy.WebSocket', {
	extend: 'Ext.data.proxy.Proxy',
	alias: 'proxy.websocket',

	requires: [
		'App.ux.data.WebSocket',
		'App.ux.data.WebSocketManager'
	],
	...
	config: {
		...
		/**
		 * @cfg {App.ux.data.WebSocket} websocket An instance of App.ux.data.WebSocket (no needs to make a new one)
		 */
		websocket: null,
	...
	/**
	 * Creates new App.ux.data.proxy.WebSocket
	 * @param {String/Object} cfg To instatiate this proxy, just define it on a model or a store.
	 *
	 *     // *** On a Model ***
	 *     Ext.define ('model', {
     *       extend: 'Ext.data.Model' ,
	 ...
	 * If you already have an instance of App.ux.data.WebSocket, just use it in place of url:
	 *
	 *     var ws = Ext.create ('App.ux.data.WebSocket', 'ws://localhost:8888');
	 *
	 *     var store = Ext.create ('Ext.data.Store', {
     *       model: 'model',
     *       storeId: 'myStore' ,
