-------------------------------------------------------------------------------- CreateInstallSQL.php Script v0.0.1-------------------------------------------------------------------------------- This script will automatically create the SQL Script-- that will used to make installations of GaiaEHR-- also this script should by runned by an CIS (Continuous Integration System)--------------------------------------------------------------------------------------------------------------------------------------------- Table accvoucher Create Script -------------------------------------------------------------DROP TABLE IF EXISTS `accvoucher`;CREATE TABLE `accvoucher` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8--------------------------------------------------------------- Table insurance_companies Create Script -------------------------------------------------------------DROP TABLE IF EXISTS `insurance_companies`;CREATE TABLE `insurance_companies` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `active` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1--------------------------------------------------------------- Table laboratories Create Script -------------------------------------------------------------DROP TABLE IF EXISTS `laboratories`;CREATE TABLE `laboratories` (
...
) ENGINE=InnoDB AUTO_INCREMENT=238 DEFAULT CHARSET=latin1--------------------------------------------------------------- Table pharmacies Create Script -------------------------------------------------------------DROP TABLE IF EXISTS `pharmacies`;CREATE TABLE `pharmacies` (
  `id` int(11) NOT NULL DEFAULT '0',
  `name` varchar(255) DEFAULT NULL,
  `transmit_method` varchar(255) DEFAULT NULL,
  `email` varchar(255) DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8--------------------------------------------------------------- Table specialties Create Script -------------------------------------------------------------DROP TABLE IF EXISTS `specialties`;CREATE TABLE `specialties` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  KEY `eid` (`eid`),
  KEY `uid` (`uid`)
) ENGINE=InnoDB AUTO_INCREMENT=1037525 DEFAULT CHARSET=utf8 COMMENT='Data INSERT UPDATE DELETE Logs'--------------------------------------------------------------- Table users Create Script -------------------------------------------------------------DROP TABLE IF EXISTS `users`;CREATE TABLE `users` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `code` varchar(40) DEFAULT NULL,
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4892 DEFAULT CHARSET=latin1--------------------------------------------------------------- Table patient_pools Create Script -------------------------------------------------------------DROP TABLE IF EXISTS `patient_pools`;CREATE TABLE `patient_pools` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`catid`),
  KEY `basic_cat` (`catname`,`catcolor`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8--------------------------------------------------------------- Table calendar_events Create Script -------------------------------------------------------------DROP TABLE IF EXISTS `calendar_events`;CREATE TABLE `calendar_events` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  KEY `IK_eid` (`eid`),
  KEY `IK_pid` (`pid`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8--------------------------------------------------------------- Table patient_allergies Create Script -------------------------------------------------------------DROP TABLE IF EXISTS `patient_allergies`;CREATE TABLE `patient_allergies` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `pid` int(11) DEFAULT NULL,
  `eid` int(11) DEFAULT NULL,
  ...
  KEY `eid` (`eid`),
  KEY `pid` (`pid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1--------------------------------------------------------------- Table encounters Create Script -------------------------------------------------------------DROP TABLE IF EXISTS `encounters`;CREATE TABLE `encounters` (
