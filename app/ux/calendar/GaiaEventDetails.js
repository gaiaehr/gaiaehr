...
Ext.define('App.ux.calendar.GaiaEventDetails', {
	...
	datesLabelText    : i18n('when'),
	reminderLabelText : i18n('reminder'),
	notesLabelText    : i18n('notes'),
	locationLabelText : i18n('location'),
	webLinkLabelText  : i18n('web_link'),
	calendarLabelText : i18n('Calendar'),
	repeatsLabelText  : i18n('repeats'),
	saveButtonText    : i18n('save'),
	deleteButtonText  : i18n('delete'),
