...
<xsl:stylesheet version="1.0" xmlns="urn:hl7-org:v3" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                xmlns:a="urn:astm-org:CCR" xmlns:date="http://exslt.org/dates-and-times"
	...
	<xsl:template match="/">
		<ClinicalDocument xmlns="urn:hl7-org:v3" xmlns:voc="urn:hl7-org:v3/voc" xmlns:sdtc="urn:hl7-org:sdtc"
			...
			<xsl:variable name="ccrFromActorObjectID"
			              select="/a:ContinuityOfCareRecord/a:Actors/a:Actor[a:ActorObjectID=$fromID]/a:InternalCCRLink[a:LinkRelationship='representedOrganization']/a:LinkID"/>
			<title>Continuity of Care Document from
				<xsl:value-of
						select="/a:ContinuityOfCareRecord/a:Actors/a:Actor[a:ActorObjectID=$ccrFromActorObjectID]/a:Organization/a:Name"/>
			</title>
			<effectiveTime>
				...
				<patientRole>
					<xsl:call-template name="ccdPatientRole">
						<xsl:with-param name="ccrActorObjectID"
						                select="/a:ContinuityOfCareRecord/a:Patient[1]/a:ActorID"/>
					</xsl:call-template>
				</patientRole>
			</recordTarget>
					...
					<xsl:attribute name="value">
						<xsl:call-template name="date:format-date">
							<xsl:with-param name="date-time"
							                select="/a:ContinuityOfCareRecord/a:DateTime/a:ExactDateTime"/>
						...
						<low>
							<xsl:attribute name="value">
								<xsl:call-template name="date:format-date">
									<xsl:with-param name="date-time">
										<xsl:for-each
												select="/a:ContinuityOfCareRecord/a:Body//a:DateTime//a:ExactDateTime">
													...
													<td>
														<xsl:call-template name="actorName">
															<xsl:with-param name="objID"
															                select="a:Source/a:Actor/a:ActorID"/>
														</xsl:call-template>
													</td>
												</tr>
											</xsl:for-each>
													...
													<participant typeCode="CSM">
														<xsl:choose>
															<xsl:when test="a:Agent/a:Products/a:Product/a:Product">
																<xsl:call-template
																		name="ccdParticipantRoleCodedDescription">
																	<xsl:with-param name="ccrCodedDescription"
																	                select="a:Product/a:Description"/>
																</xsl:call-template>
															</xsl:when>
														...
														<entryRelationship typeCode="MFST" inversionInd="true">
															<observation classCode="OBS" moodCode="EVN">
																...
																<xsl:call-template name="ccdCodedValue">
																	<xsl:with-param name="ccrCodedDescription"
																	                select="a:Reaction/a:Description"/>
																</xsl:call-template>
															</observation>
														</entryRelationship>
													</xsl:if>
								...
								<text>
									<table>
										<tbody>
											...
											<xsl:for-each
													select="/a:ContinuityOfCareRecord/a:Body/a:AdvanceDirectives/a:AdvanceDirective">
												<tr>
													<xsl:attribute name="id">
														<xsl:value-of select="a:CCRDataObjectID"/>
													</xsl:attribute>
													...
													<td>
														<xsl:call-template name="date:format-date">
															<xsl:with-param name="date-time"
															                select="a:DateTime/a:ExactDateTime"/>
														</xsl:call-template>
													</td>
													<td>
														<xsl:attribute name="id">
											...
											<xsl:if test="a:ReferenceID">
												<reference typeCode="REFR">
													<externalDocument>
														...
														<code code="371538006" codeSystem="2.16.840.1.113883.6.96"
														      displayName="Advance directive"/>
														<xsl:variable name="reference"
														              select="/a:ContinuityOfCareRecord/a:References/a:Reference[a:ReferenceObjectID=$referenceID]"/>
														<text>
															...
															<reference>
																<xsl:value-of
																		select="$reference/a:Location[1]/a:Description/a:Text"/>
															</reference>
														</text>
													</externalDocument>
												</reference>
								...
								<text>
									<table>
										<tbody>
											...
											<xsl:for-each
													select="/a:ContinuityOfCareRecord/a:Body/a:Problems/a:Problem">
												<tr>
													<td>
														<xsl:value-of select="a:Type/a:Text"/>
													</td>
								...
								<text>
									<table>
										<tbody>
											...
											<xsl:for-each
													select="/a:ContinuityOfCareRecord/a:Body/a:Procedures/a:Procedure">
												<tr>
													<xsl:attribute name="id">
														<xsl:value-of select="a:CCRDataObjectID"/>
													</xsl:attribute>
									...
									<entry typeCode="DRIV">
										<procedure classCode="PROC" moodCode="EVN">
											...
											<xsl:if test="a:Practitioners/a:Practitioner">
												<xsl:call-template name="ccdPerformer">
													<xsl:with-param name="ccrActorReference"
													                select="a:Practitioners/a:Practitioner[1]"/>
												</xsl:call-template>
											</xsl:if>
										</procedure>
									</entry>
								...
								<text>
									<table>
										<tbody>
											...
											<xsl:for-each
													select="/a:ContinuityOfCareRecord/a:Body/a:Medications/a:Medication">
												<tr>
													<td>
														<xsl:value-of select="a:Product/a:ProductName/a:Text"/>
														<xsl:if test="a:Product/a:BrandName">
															<xsl:text xml:space="preserve"> </xsl:text>(<xsl:value-of
																select="a:Product/a:BrandName/a:Text"/>)
														</xsl:if>
													</td>
													<td>
														<xsl:apply-templates select="a:DateTime"/>
															...
															<xsl:choose>
																...
																<xsl:otherwise>
																	...
																	<xsl:if test="a:Duration">
																		<xsl:text xml:space="preserve">( </xsl:text>for
																		<xsl:value-of select="a:Duration/a:Value"/><xsl:text xml:space="preserve"> </xsl:text><xsl:value-of
																			select="a:Duration/a:Units/a:Unit"/><xsl:text xml:space="preserve"> )</xsl:text>
																	</xsl:if>
																	<xsl:if test="a:MultipleDirectionModifier/a:ObjectAttribute">
																		<xsl:for-each
																				select="a:MultipleDirectionModifier/a:ObjectAttribute">
																			<xsl:value-of select="a:Attribute"/>
																			<br/>
																			<xsl:value-of
																					select="a:AttributeValue/a:Value"/>
																		</xsl:for-each>
																	</xsl:if>
																</xsl:otherwise>
															</xsl:choose>
													...
													<td>
														<xsl:for-each select="a:Directions/a:Direction[1]/a:Indication">
															<xsl:call-template name="problemDescription">
																<xsl:with-param name="objID"
																                select="a:InternalCCRLink/a:LinkID"/>
															</xsl:call-template>
															<br/>
														</xsl:for-each>
													</td>
										...
										<substanceAdministration classCode="SBADM" moodCode="EVN">
											...
											<xsl:call-template name="ccdMedicationFrequency">
												<xsl:with-param name="frequency"
												                select="a:Directions/a:Direction/a:Frequency"/>
											</xsl:call-template>

											<xsl:call-template name="ccdCodedValue">
												<xsl:with-param name="ccrCodedDescription"
												                select="a:Directions/a:Direction/a:Route"/>
											...
											<consumable>
												<manufacturedProduct>
													...
													<manufacturedMaterial>
														<xsl:call-template name="ccdCodedValue">
															<xsl:with-param name="ccrCodedDescription"
															                select="a:Product/a:ProductName"/>
															<xsl:with-param name="nodeName" select="'code'"/>
														</xsl:call-template>
														<name>
												...
												<tr>
													...
													<td>
														...
														<xsl:if test="a:Product/a:Form">
															<xsl:text xml:space="preserve"> </xsl:text>(<xsl:value-of
																select="a:Product/a:Form/a:Text"/>)
														</xsl:if>
													</td>
													<td>
														<xsl:apply-templates select="a:DateTime"/>
									...
									<entry typeCode="DRIV">
										<substanceAdministration classCode="SBADM" moodCode="EVN">
											...
											<xsl:if test="a:Directions/a:Direction/a:Site">
												<xsl:call-template name="ccdCodedValue">
													<xsl:with-param name="ccrCodedDescription"
													                select="a:Directions/a:Direction/a:Site"/>
													<xsl:with-param name="nodeName" select="'approachSiteCode'"/>
													<xsl:with-param name="originalTextReference">
														<xsl:text>#</xsl:text>
														<xsl:value-of select="a:CCRDataObjectID"/>
								...
								<text>
									<table>
										<tbody>
											...
											<xsl:for-each
													select="/a:ContinuityOfCareRecord/a:Body/a:VitalSigns/a:Result">
												<tr>
													<xsl:attribute name="id">
														<xsl:value-of select="a:CCRDataObjectID"/>
													</xsl:attribute>
								...
								<text>
									<table>
										<tbody>
											...
											<xsl:for-each
													select="/a:ContinuityOfCareRecord/a:Body/a:Encounters/a:Encounter">
												<tr>
													<xsl:attribute name="id">
														<xsl:value-of select="a:CCRDataObjectID"/>
													</xsl:attribute>
												...
												<participant typeCode="LOC">
													...
													<xsl:choose>
														<xsl:when test="a:Locations[1]/a:Location/a:ActorID">
															<xsl:call-template name="ccdParticipantRoleActor">
																<xsl:with-param name="ccrActorObjectID"
																                select="a:Locations[1]/a:Location/a:ActorID"/>
															</xsl:call-template>
														</xsl:when>
														<xsl:otherwise>
															<xsl:call-template
																	name="ccdParticipantRoleCodedDescription">
																<xsl:with-param name="ccrCodedDescription"
																                select="a:Locations[1]/a:Location/a:Description"/>
															</xsl:call-template>
														</xsl:otherwise>
													</xsl:choose>
												</participant>
						...
						<component>
							<section>
								...
								<text>
									<table>
										<tbody>
											...
											<xsl:for-each
													select="/a:ContinuityOfCareRecord/a:Body/a:SocialHistory/a:SocialHistoryElement">
												<tr>
													<td>
														<xsl:value-of select="a:Type/a:Text"/>
													</td>
								...
								<xsl:for-each
									...
									<entry typeCode="DRIV">
										<observation classCode="OBS" moodCode="EVN">
											<templateId root="2.16.840.1.113883.3.88.11.83.19"
											            assigningAuthorityName="HITSP C83"/>
								...
								<text>
									<table>
										<tbody>
											...
											<xsl:for-each
													select="/a:ContinuityOfCareRecord/a:Body/a:FamilyHistory/a:FamilyProblemHistory">
												<tr>
													<td>
														<xsl:value-of select="a:Type/a:Text"/>
													</td>
												...
												<tr>
													...
													<td>
														<xsl:for-each select="a:IDs">
															<xsl:value-of select="a:Type/a:Text"/>:<xsl:text xml:space="preserve"> </xsl:text><xsl:value-of
																select="a:ID"/>
															<br/>
														</xsl:for-each>
													</td>
													<td>
														<xsl:call-template name="actorName">
															<xsl:with-param name="objID"
															                select="a:PaymentProvider/a:ActorID"/>
														</xsl:call-template>
													</td>
													<td>
														<xsl:call-template name="actorName">
															<xsl:with-param name="objID"
															                select="a:Subscriber/a:ActorID"/>
														</xsl:call-template>
													</td>
													<td>
														<xsl:call-template name="actorName">
					...
					<xsl:if test="a:ContinuityOfCareRecord/a:Body/a:PlanOfCare">
						<component>
							<section>
									...
									<xsl:if test="a:ContinuityOfCareRecord/a:Body/a:PlanOfCare/a:Plan[a:Type/a:Text='Treatment Recommendation']">
										...
										<table>
											<tbody>
												...
												<xsl:for-each
														select="/a:ContinuityOfCareRecord/a:Body/a:PlanOfCare/a:Plan[a:Type/a:Text='Treatment Recommendation']">
													<tr>
														<td>
															<xsl:value-of select="a:Description/a:Text"/>
														</td>
														...
														<td>
															<xsl:value-of
																	select="a:OrderRequest/a:Goals/a:Goal/a:Description/a:Text"
																	disable-output-escaping="yes"/>
														</td>
														<td>
															<xsl:value-of select="a:Status/a:Text"/>
									...
									<xsl:if test="a:ContinuityOfCareRecord/a:Body/a:PlanOfCare/a:Plan[a:Type/a:Text='Order']">
										...
										<table>
											<tbody>
												...
												<xsl:for-each
														select="/a:ContinuityOfCareRecord/a:Body/a:PlanOfCare/a:Plan[a:Type/a:Text='Order']">
													<tr>
														<td>
														...
														<td>
															<xsl:value-of
																	select="a:OrderRequest/a:Procedures/a:Procedure/a:Type/a:Text"/>
														</td>
														<td>
															<xsl:call-template name="date:format-date">
																<xsl:with-param name="date-time"
																                select="a:OrderRequest/a:Procedures/a:Procedure/a:DateTime/a:ExactDateTime"/>
															</xsl:call-template>
														</td>
														<td>
															<xsl:apply-templates
																	select="a:OrderRequest/a:Procedures/a:Procedure/a:Description/a:Text"/>
														</td>
														<td>
															<xsl:text xml:space="preserve">Every </xsl:text>
															<xsl:apply-templates
																	select="a:OrderRequest/a:Procedures/a:Procedure/a:Interval/a:Value"/>
															<xsl:text xml:space="preserve"> </xsl:text>
															<xsl:value-of
																	select="a:OrderRequest/a:Procedures/a:Procedure/a:Interval/a:Units/a:Unit"/>
															<xsl:text xml:space="preserve"> for </xsl:text>
															<xsl:value-of
																	select="a:OrderRequest/a:Procedures/a:Procedure/a:Duration/a:Value"/>
															<xsl:text xml:space="preserve"> </xsl:text>
															<xsl:value-of
																	select="a:OrderRequest/a:Procedures/a:Procedure/a:Duration/a:Units/a:Unit"/>
														</td>
														<td>
															<xsl:for-each
																	select="a:OrderRequest/a:Procedures/a:Procedure/a:Locations">
														...
														<td>
															<xsl:value-of
																	select="a:OrderRequest/a:Procedures/a:Procedure/a:Substance/a:Text"/>
														</td>
														<td>
															<xsl:value-of
																	select="a:OrderRequest/a:Procedures/a:Procedure/a:Method/a:Text"/>
														</td>
														<td>
															<xsl:value-of
																	select="a:OrderRequest/a:Procedures/a:Procedure/a:Position/a:Text"/>
														</td>
														<td>
															<xsl:value-of
																	select="a:OrderRequest/a:Procedures/a:Procedure/a:Site/a:Text"/>
														</td>
														<td/>
														<td>
															<xsl:call-template name="actorName">
								...
								<xsl:for-each
										select="/a:ContinuityOfCareRecord/a:Body/a:PlanOfCare/a:Plan/a:OrderRequest/a:Procedures/a:Procedure">
									<entry typeCode="DRIV">
								...
								<xsl:for-each
										select="/a:ContinuityOfCareRecord/a:Body/a:PlanOfCare/a:Plan/a:OrderRequest/a:Medications/a:Medication">
									<entry typeCode="DRIV">
								...
								<xsl:for-each
										select="/a:ContinuityOfCareRecord/a:Body/a:PlanOfCare/a:Plan/a:OrderRequest/a:Immunizations/a:Immunization">
								...
								<xsl:for-each
										select="/a:ContinuityOfCareRecord/a:Body/a:PlanOfCare/a:Plan/a:OrderRequest/a:Encounters/a:Encounter">
									<entry typeCode="DRIV">
								...
								<text>
									<table>
										<tbody>
											...
											<xsl:for-each
													select="/a:ContinuityOfCareRecord/a:Body/a:HealthCareProviders/a:Provider">
												<tr>
													<td>
									...
									<table>
										<tbody>
											...
											<xsl:for-each select="/a:ContinuityOfCareRecord/a:Actors/a:Actor">
												<xsl:sort
														select="a:Person/a:Name/a:DisplayName|a:Person/a:Name/a:CurrentName/a:Family"
								...
								<xsl:if test="a:ContinuityOfCareRecord/a:Actors/a:Actor[a:Organization]">
									<table>
										<tbody>
											...
											<xsl:for-each select="/a:ContinuityOfCareRecord/a:Actors/a:Actor">
												<xsl:sort select="a:Organization/a:Name" data-type="text"
												          order="ascending"/>
								...
								<xsl:if test="a:ContinuityOfCareRecord/a:Actors/a:Actor[a:InformationSystem]">
									<table>
										<tbody>
											...
											<xsl:for-each select="/a:ContinuityOfCareRecord/a:Actors/a:Actor">
												<xsl:sort select="a:InformationSystem/a:Name" data-type="text"
												          order="ascending"/>
	...
	<xsl:template name="ccdAssignedEntity">
		...
		<xsl:variable name="CCRActor"
		              select="/a:ContinuityOfCareRecord/a:Actors/a:Actor[a:ActorObjectID=$ccrActorObjectID]"/>
		...
		<assignedEntity>
			...
			<xsl:if test="$CCRActor/a:InternalCCRLink[a:LinkRelationship='Organization']">
				<xsl:call-template name="ccdOrganization">
					<xsl:with-param name="ccrActorObjectID"
					                select="$CCRActor/a:InternalCCRLink[a:LinkRelationship='Organization']/a:LinkID"/>
	...
	<xsl:template name="ccdPatient">
		...
		<patient>
			...
			<xsl:if test="/a:ContinuityOfCareRecord/a:Body/a:SocialHistory/a:SocialHistoryElement[a:Type/a:Text='Marital Status']">
				<xsl:call-template name="ccdCodedValue">
					<xsl:with-param name="ccrCodedDescription"
					                select="/a:ContinuityOfCareRecord/a:Body/a:SocialHistory/a:SocialHistoryElement[a:Type/a:Text='Marital Status']/a:Description"/>
				...
				<effectiveTime>
					<low>
						<xsl:attribute name="value">
							<xsl:call-template name="date:format-date">
								<xsl:with-param name="date-time"
								                select="$dt[1]/a:DateTimeRange/a:BeginRange/a:ExactDateTime"/>
								<xsl:with-param name="pattern">yyyyMMdd</xsl:with-param>
							</xsl:call-template>
						</xsl:attribute>
					</low>
					<high>
						<xsl:attribute name="value">
							<xsl:call-template name="date:format-date">
								<xsl:with-param name="date-time"
								                select="$dt[1]/a:DateTimeRange/a:EndRange/a:ExactDateTime"/>
								<xsl:with-param name="pattern">yyyyMMdd</xsl:with-param>
							</xsl:call-template>
						</xsl:attribute>
					</high>
