/**
 * @class App.ux.data.WebSocketManager
 ...
 *     });
 *
 *     App.ux.data.WebSocketManager.register (ws1);
 *
 *     var ws2 = Ext.create ('Ext.ux.WebSocket', {
 *       url: 'ws://localhost:8900'
 *     });
 *
 *     App.ux.data.WebSocketManager.register (ws2);
 *
 *     var ws3 = Ext.create ('Ext.ux.WebSocket', {
 *       url: 'ws://localhost:8950'
 *     });
 *
 *     App.ux.data.WebSocketManager.register (ws3);
 *
 *     App.ux.data.WebSocketManager.listen ('system shutdown', function (ws, data) {
 *       Ext.Msg.show ({
 ...
 *     });
 *
 *     App.ux.data.WebSocketManager.broadcast ('system shutdown', 'BROADCAST: the system will shutdown in few minutes.');
 *
 *     App.ux.data.WebSocketManager.closeAll ();
 *
 *     App.ux.data.WebSocketManager.unregister (ws1);
 *     App.ux.data.WebSocketManager.unregister (ws2);
 *     App.ux.data.WebSocketManager.unregister (ws3);
 */
Ext.define('App.ux.data.WebSocketManager', {
    singleton: true,
