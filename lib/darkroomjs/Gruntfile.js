			...
			main: {
				...
				files: {
					'build/js/darkroom.min.js': [
						'build/lib/js/plugins/zynga/Animate.js',
						'build/lib/js/plugins/zynga/EasyScroller.js',
						'build/lib/js/plugins/zynga/Scroller.js',
						'build/lib/js/darkroom.js',
						'build/lib/js/plugins/darkroom.history.js',
						'build/lib/js/plugins/darkroom.rotate.js',
						'build/lib/js/plugins/darkroom.zoom.js',
