		                ...
		                items: [
			                {
				                ...
				                itemId: 'image',
				                margin: '0 5 0 0',
				                src: 'data:image/jpeg;base64,' + me.defaultPatientImage
			                },
			                {
				                xtype: 'textareafield',
				                name: 'image',
			                ...
			                },
			                {
				                ...
				                height: 119,
				                margin: 0,
				                src: 'data:image/jpeg;base64,' + me.defaultQRCodeImage
			                }
		                ],
		                bbar: [
			                '-',
...
//				                handler: me.getPhotoIdWindow
		        ...
		        items: [
			        {
				        ...
				        width: 253,
				        height: 153,
				        src: 'data:image/jpeg;base64,' + me.defaultInsImage
			        },
			        {
				        xtype: 'textareafield',
				        action: 'insImage',
	...
	insurancePanelAdd:function(tapPanel, form){
		...
		if(rec.data.image != '') form.down('image').setSrc('data:image/jpeg;base64,' + rec.data.image);
	},
    ...
    getPatientImages: function(record){
        var me = this;
	    me.patientImages.getComponent('image').setSrc('data:image/jpeg;base64,' + (record.data.image != '' ? record.data.image : me.defaultInsImage));
	    me.patientImages.getComponent('qrcode').setSrc('data:image/jpeg;base64,' + (record.data.qrcode != '' ? record.data.qrcode : me.defaultQRCodeImage));
    },
