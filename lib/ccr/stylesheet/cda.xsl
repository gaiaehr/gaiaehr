...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="n1:ClinicalDocument">
        <html>
            ...
            <body>
                ...
                <hr align="left" color="gray" size="2" width="100%"/>
    ...
    <xsl:template match="n1:table">
        <table class="narr_table" border="0" cellpadding="0" cellspacing="0">
            <xsl:copy-of select="@*"/>
            <xsl:apply-templates/>
        </table>
    </xsl:template>
...
.narr_th {
	...
	border-color: #D0D0D0 #D0D0D0 #D0D0D0 #EEEEEE;
	border-image: none;
	border-style: solid;
	border-width: 1px;
	font-weight: bold;
