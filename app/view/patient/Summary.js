...
Ext.define('App.view.patient.Summary', {
    ...
    initComponent: function() {
        ...
        me.immuCheckListStore = Ext.create('App.store.patient.ImmunizationCheck');
        ...
        me.patientDocumentsStore = Ext.create('App.store.patient.PatientDocuments');
        me.patientNotesStore = Ext.create('App.store.patient.Notes');
        me.patientRemindersStore = Ext.create('App.store.patient.Reminders');

        me.patientsDismissedAlerts = Ext.create('App.store.patient.DismissedAlerts');

	    me.encounterEventHistoryStore = Ext.create('App.store.patient.Encounters');
