...
class Navigation {
    ...
    public function getNavigation(){
        ...
        $nav = array(
	        ...
	        array( 'text' => $this->i18n['report_center'],  'disabled'=> false, 'leaf' => true, 'cls' => 'file', 'iconCls' => 'file',  'id' => 'panelReportCenter' ),
        );
	    ...
	    if($this->ACL->hasPermission('access_medications')){
		    $admin['children'][] = array( 'text' => $this->i18n['medications'], 'leaf' => true, 'cls' => 'file', 'id' => 'panelMedications' );
	    }
        ...
        array_push( $nav, array( 'text' => $this->i18n['miscellaneous'], 'cls' => 'folder', 'expanded' => false, 'id' => 'navigationMiscellaneous', 'children' =>
            array(
                ...
                array( 'text' => $this->i18n['office_notes'],    'leaf' => true, 'cls' => 'file', 'id' => 'panelOfficeNotes' ),
                array( 'text' => $this->i18n['my_settings'],     'leaf' => true, 'cls' => 'file', 'id' => 'panelMySettings' ),
