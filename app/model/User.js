...
Ext.define('App.model.User',{
	...
	fields: [
		...
		{name: 'title',             type: 'string', comment:'title (Mr. Mrs.)'},
		...
		{name: 'fullname',          type: 'string', comment:'title full name', store: false},
		...
		{name: 'taxonomy',          type: 'string', comment:'taxonomy', defaultValue:'207Q00000X'},

		{name: 'warehouse_id',      type: 'int',    comment:'default warehouse'},
