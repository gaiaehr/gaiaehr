 ...
 */
Ext.define('App.ux.calendar.GaiaEventDetails', {
...
//		'Extensible.form.recurrence.Combo'
	...
	colWidthRight     : .4,
	title             : _('event_form'),
	titleTextAdd      : _('add_appointment') + '...',
	titleTextEdit     : _('edit_appointment'),
	titleLabelText    : _('title'),
	datesLabelText    : _('when'),
	reminderLabelText : _('reminder'),
	notesLabelText    : _('notes'),
	locationLabelText : _('location'),
	webLinkLabelText  : _('web_link'),
	calendarLabelText : _('Calendar'),
	repeatsLabelText  : _('repeats'),
