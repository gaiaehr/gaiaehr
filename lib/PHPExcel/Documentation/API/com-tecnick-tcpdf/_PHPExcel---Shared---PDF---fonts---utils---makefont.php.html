<html>
<head>
<title>Docs for page makefont.php</title>
...
<h1>Procedural File: makefont.php</h1>
Source Location: /PHPExcel/Shared/PDF/fonts/utils/makefont.php<br /><br />
...
<h2>Page Details:</h2>
Utility to generate font definition files fot TCPDF.<br /><br /><br /><br />
<h4>Tags:</h4>
<div class="tags">
<table border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><b>author:</b>&nbsp;&nbsp;</td><td>Nicola Asuni, Olivier Plathey, Steven Wittens</td>
  </tr>
  <tr>
...
<br />
  <hr />
	<a name="functionCheckTTF"></a>
	<h3>CheckTTF <span class="smalllinenumber">[line 550]</span></h3>
	<div class="function">
 ...
 $file)</code>
  ...
  <hr />
	<a name="functionMakeFont"></a>
	<h3>MakeFont <span class="smalllinenumber">[line 60]</span></h3>
	<div class="function">
    <table width="90%" border="0" cellspacing="0" cellpadding="1"><tr><td class="code_border">
    <table width="100%" border="0" cellspacing="0" cellpadding="2"><tr><td class="code">
		<code>void MakeFont(
string $fontfile, string $fmfile, [boolean $embedded = true], [string $enc = &#039;cp1252&#039;], [array $patch = array()])</code>
    </td></tr></table>
    </td></tr></table><br />
    ...
    <table border="0" cellspacing="0" cellpadding="0">
        ...
        <td><b>$fontfile</b>&nbsp;&nbsp;</td>
        <td>path to font file (TTF, OTF or PFB).</td>
      </tr>
		      <tr>
        <td class="type">string&nbsp;&nbsp;</td>
        <td><b>$fmfile</b>&nbsp;&nbsp;</td>
        <td>font metrics file (UFM or AFM).</td>
      </tr>
		      <tr>
        <td class="type">boolean&nbsp;&nbsp;</td>
        <td><b>$embedded</b>&nbsp;&nbsp;</td>
        <td>Set to false to not embed the font, true otherwise (default).</td>
      </tr>
		      <tr>
        <td class="type">string&nbsp;&nbsp;</td>
        <td><b>$enc</b>&nbsp;&nbsp;</td>
        <td>Name of the encoding table to use. Omit this parameter for TrueType Unicode, OpenType Unicode and symbolic fonts like Symbol or ZapfDingBats.</td>
      </tr>
		      <tr>
        <td class="type">array&nbsp;&nbsp;</td>
        <td><b>$patch</b>&nbsp;&nbsp;</td>
        <td>Optional modification of the encoding</td>
      </tr>
				</table>
    	<div class="top">[ <a href="#top">Top</a> ]</div><br /><br />
	</div>
  <hr />
	<a name="functionMakeFontDescriptor"></a>
	<h3>MakeFontDescriptor <span class="smalllinenumber">[line 441]</span></h3>
	<div class="function">
    <table width="90%" border="0" cellspacing="0" cellpadding="1"><tr><td class="code_border">
    <table width="100%" border="0" cellspacing="0" cellpadding="2"><tr><td class="code">
		<code>void MakeFontDescriptor(
 $fm, [ $symbolic = false])</code>
    </td></tr></table>
    </td></tr></table><br />
  ...
  <hr />
	<a name="functionMakeFontEncoding"></a>
	<h3>MakeFontEncoding <span class="smalllinenumber">[line 514]</span></h3>
	<div class="function">
    <table width="90%" border="0" cellspacing="0" cellpadding="1"><tr><td class="code_border">
    <table width="100%" border="0" cellspacing="0" cellpadding="2"><tr><td class="code">
		<code>void MakeFontEncoding(
 $map)</code>
    </td></tr></table>
    </td></tr></table><br />
  ...
  <hr />
	<a name="functionMakeWidthArray"></a>
	<h3>MakeWidthArray <span class="smalllinenumber">[line 498]</span></h3>
	<div class="function">
    <table width="90%" border="0" cellspacing="0" cellpadding="1"><tr><td class="code_border">
    <table width="100%" border="0" cellspacing="0" cellpadding="2"><tr><td class="code">
		<code>void MakeWidthArray(
 $fm)</code>
    </td></tr></table>
    </td></tr></table><br />
  ...
  <hr />
	<a name="functionReadAFM"></a>
	<h3>ReadAFM <span class="smalllinenumber">[line 315]</span></h3>
	<div class="function">
    <table width="90%" border="0" cellspacing="0" cellpadding="1"><tr><td class="code_border">
    <table width="100%" border="0" cellspacing="0" cellpadding="2"><tr><td class="code">
		<code>void ReadAFM(
 $file,  &$map)</code>
  ...
  <hr />
	<a name="functionReadLong"></a>
	<h3>ReadLong <span class="smalllinenumber">[line 545]</span></h3>
	<div class="function">
    <table width="90%" border="0" cellspacing="0" cellpadding="1"><tr><td class="code_border">
    <table width="100%" border="0" cellspacing="0" cellpadding="2"><tr><td class="code">
		<code>void ReadLong(
 $f)</code>
  ...
  <hr />
	<a name="functionReadMap"></a>
	<h3>ReadMap <span class="smalllinenumber">[line 213]</span></h3>
	<div class="function">
    <table width="90%" border="0" cellspacing="0" cellpadding="1"><tr><td class="code_border">
    <table width="100%" border="0" cellspacing="0" cellpadding="2"><tr><td class="code">
		<code>void ReadMap(
string $enc)</code>
		...
		Read the specified encoding map.<br /><br />    <br /><br />
    ...
    <table border="0" cellspacing="0" cellpadding="0">
        ...
        <td class="type">string&nbsp;&nbsp;</td>
        <td><b>$enc</b>&nbsp;&nbsp;</td>
        <td>map name (see /enc/ folder for valid names).</td>
      </tr>
				</table>
    	<div class="top">[ <a href="#top">Top</a> ]</div><br /><br />
	</div>
  <hr />
	<a name="functionReadShort"></a>
	<h3>ReadShort <span class="smalllinenumber">[line 540]</span></h3>
	<div class="function">
    <table width="90%" border="0" cellspacing="0" cellpadding="1"><tr><td class="code_border">
    <table width="100%" border="0" cellspacing="0" cellpadding="2"><tr><td class="code">
		<code>void ReadShort(
 $f)</code>
  ...
  <hr />
	<a name="functionReadUFM"></a>
	<h3>ReadUFM <span class="smalllinenumber">[line 240]</span></h3>
	<div class="function">
    <table width="90%" border="0" cellspacing="0" cellpadding="1"><tr><td class="code_border">
    <table width="100%" border="0" cellspacing="0" cellpadding="2"><tr><td class="code">
		<code>void ReadUFM(
 $file,  &$cidtogidmap)</code>
    </td></tr></table>
    </td></tr></table><br />

		Read UFM file<br /><br />    <br /><br />
  ...
  <hr />
	<a name="functionSaveToFile"></a>
	<h3>SaveToFile <span class="smalllinenumber">[line 531]</span></h3>
	<div class="function">
    <table width="90%" border="0" cellspacing="0" cellpadding="1"><tr><td class="code_border">
    <table width="100%" border="0" cellspacing="0" cellpadding="2"><tr><td class="code">
		<code>void SaveToFile(
 $file,  $s, [ $mode = &#039;t&#039;])</code>
    </td></tr></table>
    </td></tr></table><br />
    ...
    <table border="0" cellspacing="0" cellpadding="0">
        ...
        <div class="credit">
		    <hr />
		    Documentation generated on Sat, 19 May 2012 14:37:55 +0200 by <a href="http://www.phpdoc.org">phpDocumentor 1.4.4</a>
	      </div>
      </td></tr></table>
    </td>
  </tr>
