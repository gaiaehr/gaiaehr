 ...
 *
 *     var websocket = Ext.create ('App.ux.data.WebSocket', {
...
Ext.define('App.ux.data.WebSocket', {
    alias: 'websocket',
     ...
     * @param {App.ux.data.WebSocket} this The websocket
     */
	 ...
	 *     };
     *
     *     var ws = Ext.create ('App.ux.data.WebSocket', config);
     *
     *     // or with websocket url only
     *     var ws = Ext.create ('App.ux.data.WebSocket', 'ws://localhost:30000');
     *
    ...
    constructor: function (cfg) {
        ...
        // e.g.: Ext.create ('App.ux.data.WebSocket', 'ws://localhost:8888');
