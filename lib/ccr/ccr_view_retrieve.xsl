...
this XSLT back to the community.  
 ...
 -->
<xsl:stylesheet exclude-result-prefixes="a date str" version="1.0" xmlns:a="urn:astm-org:CCR"
									...
									<tbody>
										<tr id="ccrheaderrow">
											<td>
												...
												<table bgColor="#ffffcc" cellPadding="1" cellSpacing="3" id="ccrheader"
												       width="75%">
													<tbody>
														<tr>
															<td>
															...
															<td>
																<xsl:call-template name="date:format-date">
																	...
																	<xsl:with-param name="pattern">EEE MMM dd, yyyy 'at'
																		hh:mm aa zzz
																	</xsl:with-param>
																</xsl:call-template>
															</td>
														...
														<tr>
															...
															<td>
																<xsl:for-each
																		select="a:ContinuityOfCareRecord/a:From/a:ActorLink">
														...
														<tr>
															...
															<td>
																<xsl:for-each
																		select="a:ContinuityOfCareRecord/a:To/a:ActorLink">
																	<xsl:call-template name="actorName">
																		<xsl:with-param name="objID"
																		                select="a:ActorID"/>
																	</xsl:call-template>
												...
												<table class="list" id="demographics">
													<tbody>
														...
														<xsl:for-each select="a:ContinuityOfCareRecord/a:Patient">
															...
															<xsl:for-each
																	select="/a:ContinuityOfCareRecord/a:Actors/a:Actor">
																<xsl:variable name="thisObjID"
																              select="a:ActorObjectID"/>
																<xsl:if test="$objID = $thisObjID">
																	<tr>
																		...
																		<td>
																			<xsl:value-of
																					select="a:Person/a:Gender/a:Text"/>
																		</td>
																		<td>
																			<table class="internal">
																				<tbody>
										...
										<span id="ccrcontent">
													...
													<td>
														...
														<table class="list" id="alerts">
															<tbody>
																...
																<xsl:for-each
																		select="a:ContinuityOfCareRecord/a:Body/a:Alerts/a:Alert">
																	<tr>
																		<td>
																		...
																		<td>
																			<xsl:apply-templates
																					select="a:Description/a:Code"/>
																		</td>
																		<td>
																			<strong class="clinical">
																				<xsl:value-of
																						select="a:Description/a:Text"/>
																			</strong>
																		</td>
																		<td>
																			<xsl:value-of
																					select="a:Reaction/a:Description/a:Text"/>
																			<xsl:if test="a:Reaction/a:Severity/a:Text">
																				<xsl:text>-</xsl:text>
																				<xsl:value-of
																						select="a:Reaction/a:Severity/a:Text"/>
																			</xsl:if>
																		</td>
																		<td>
																			<a>
											...
											<xsl:if test="a:ContinuityOfCareRecord/a:Body/a:Support">
												<tr id="supportprovidersrow">
													<td>
														<span class="header" id="supportproviders">Support Providers
														</span>
														<br/>
														<table class="list">
															<tbody>
																...
																<xsl:for-each
																		select="a:ContinuityOfCareRecord/a:Body/a:Support/a:SupportProvider">
																	<tr>
																		<td>
																			<xsl:value-of select="a:ActorRole/a:Text"/>
																		</td>
													...
													<td>
														...
														<table class="list">
															<tbody>
																...
																<xsl:for-each
																		select="a:ContinuityOfCareRecord/a:Body/a:FunctionalStatus/a:Function">
																	<tr>
																		<td>
																			<xsl:value-of select="a:Type/a:Text"/>
																		</td>
																...
																<xsl:for-each
																	...
																	<tr>
																		<td>
																			<strong class="clinical">
																				<xsl:value-of
																						select="a:Product/a:ProductName/a:Text"/>
																		...
																		<td>
																			...
																			<xsl:text xml:space="preserve"> </xsl:text>
																			<xsl:value-of
																					select="a:Quantity/a:Units/a:Unit"/>
																		</td>
																		<td>
																		...
																		<td>
																			<xsl:for-each
																					select="a:Indications/a:Indication">
																				<xsl:call-template
																		...
																		<td>
																			<xsl:for-each
																					select="a:PatientInstructions/a:Instruction">
																				<xsl:value-of select="a:Text"/>
																				<br/>
																			</xsl:for-each>
																		</td>
															...
															<tbody>
																...
																<xsl:for-each
																	...
																	<tr>
																		...
																		<td>
																			<xsl:value-of
																					select="a:Directions/a:Direction/a:Route/a:Text"/>
																		</td>
																		<td>
																			<xsl:value-of
																					select="a:Directions/a:Direction/a:Site/a:Text"/>
																		</td>
																		<td>
																			<a>
																				<xsl:attribute name="href">
																			...
																			<table class="internal">
																				<tbody>
																					<xsl:call-template name="dateTime">
																						<xsl:with-param name="dt"
																						                select="a:DateTime"/>
																						<xsl:with-param name="fmt">MMM
																							dd, yyyy ':' hh:mm aa zzz
																						</xsl:with-param>
																					</xsl:call-template>
																				</tbody>
																			</table>
																						...
																						<xsl:choose>
																							<xsl:when
																								...
																								<tr class="even">
																									...
																									<td width="33%">
																										<xsl:value-of
																												select="a:TestResult/a:Value"/>
																										<xsl:text xml:space="preserve"> </xsl:text>
																										<xsl:value-of
																												select="a:TestResult/a:Units/a:Unit"/>
																									</td>
																									<td width="33%">
																										<xsl:value-of
																												select="a:Flag/a:Text"/>
																									</td>
																								</tr>
																							</xsl:when>
																							<xsl:otherwise>
															...
															<tbody>
																...
																<xsl:for-each
																	...
																	<tr>
																		...
																		<td>
																			<xsl:for-each
																					select="a:Practitioners/a:Practitioner">
																				<xsl:call-template name="actorName">
																					<xsl:with-param name="objID"
																					                select="a:ActorID"/>
																				</xsl:call-template>
															...
															<tbody>
																...
																<xsl:for-each
																	...
																	<tr>
																		...
																		<td>
																			<xsl:apply-templates
																					select="a:Problem/a:Description/a:Code"/>
																		</td>
																		<td>
																			<table class="internal"
																			       id="familyhistoryproblem">
																		...
																		<td>
																			<xsl:value-of
																					select="a:FamilyMember/a:ActorRole/a:Text"/>
																		</td>
																		<td>
																			<xsl:value-of select="a:Status/a:Text"/>
																		</td>
													...
													<td>
														...
														<table class="list" id="results">
															<tbody>
																...
																<xsl:for-each
																		select="a:ContinuityOfCareRecord/a:Body/a:Results/a:Result[a:Test/a:TestResult/a:Value!='']">
																	<tr>
																		<td>
																			<xsl:value-of
																					select="a:Description/a:Text"/>
													...
													<td>
														...
														<table class="list" id="resultsreport">
															<tbody>
																...
																<xsl:for-each
																		select="a:ContinuityOfCareRecord/a:Body/a:Results/a:Result[a:Test/a:TestResult/a:Description/a:Text!='']">
																	<tr>
																		<td>
																			<xsl:value-of
																					select="a:Description/a:Text"/>
																								...
																								<tr class="even">
																									...
																									<td width="65%">
																										<span>
																											<xsl:value-of
																													disable-output-escaping="yes"
																													select="a:TestResult/a:Description/a:Text"/>
																										</span>
																									</td>
																									<td width="15%">
																										<xsl:value-of
													...
													<td>
														...
														<table class="list" id="insurance">
															<tbody>
																...
																<xsl:for-each
																		select="a:ContinuityOfCareRecord/a:Body/a:Payers/a:Payer">
																	<tr>
																		<td>
																			<xsl:value-of select="a:Type/a:Text"/>
																		</td>
																	...
																	<xsl:for-each
																		...
																		<tr>
																			...
																			<td>
																				<xsl:value-of
																						disable-output-escaping="yes"
																						select="a:OrderRequest/a:Description/a:Text"/>
																			</td>
																			<td>
																				<xsl:value-of
																						disable-output-escaping="yes"
																		...
																		<tr>
																				...
																				<table class="internal">
																					<tbody>
																						<xsl:call-template
																								name="dateTime">
																							<xsl:with-param name="dt"
																							                select="a:OrderRequest/a:Procedures/a:Procedure/a:DateTime"/>
																						</xsl:call-template>
																					</tbody>
																				</table>
																			</td>
																			...
																			<td>
																				<xsl:for-each
																					...
																					<xsl:value-of
																							select="a:Location/a:Description/a:Text"/>
																					<xsl:if test="position() != last()">
																						<br/>
																					</xsl:if>
																				</xsl:for-each>
													...
													<td>
														...
														<table class="list" id="references">
															<tbody>
																...
																<xsl:for-each
																		select="a:ContinuityOfCareRecord/a:References/a:Reference">
																	<tr>
																		<td>
																			<xsl:value-of select="a:Type/a:Text"/>
																		</td>
																		...
																		<td>
																			<a target="_blank">
																				<xsl:attribute name="href">
																					<xsl:value-of
																							select="a:Locations/a:Location/a:Description/a:Text"/>
																				</xsl:attribute>
																				<xsl:value-of
																						select="a:Locations/a:Location/a:Description/a:Text"/>
																			</a>
						...
						<span id="informationsystems">
							...
							<table class="list" id="informationsystemstable">
								<tbody>
									...
									<xsl:for-each select="a:ContinuityOfCareRecord/a:Actors/a:Actor">
										<xsl:sort data-type="text" order="ascending"
										          select="a:InformationSystem/a:Name"/>
						...
						<xsl:choose>
							...
							<xsl:when test="$pattern-length >= 3">
								<xsl:variable name="month-node"
								              select="document('')/*/date:months/date:month[number($month)]"/>
								<xsl:choose>
						...
						<xsl:choose>
							...
							<xsl:otherwise>
								<xsl:variable name="month-days"
								              select="sum(document('')/*/date:months/date:month[position() &lt; $month]/@length)"/>
								<xsl:variable name="days"
								              select="$month-days + $day + boolean(((not(boolean($year mod 4)) and $year mod 100) or not(boolean($year mod 400))) and $month > 2)"/>
						...
						<xsl:choose>
							...
							<xsl:otherwise>
								<xsl:variable name="month-days"
								              select="sum(document('')/*/date:months/date:month[position() &lt; $month]/@length)"/>
								<xsl:variable name="days"
								              select="$month-days + $day + boolean(((not($year mod 4) and $year mod 100) or not($year mod 400)) and $month > 2)"/>
								<xsl:choose>
									<xsl:when test="$char = 'D'">
			...
			<xsl:if test="$objID = $thisObjID">
				<xsl:choose>
					...
					<xsl:when test="a:InformationSystem">
						...
						<xsl:if test="a:InformationSystem/a:Type">(<xsl:value-of select="a:InformationSystem/a:Type"/>)
						</xsl:if>
					</xsl:when>
					<xsl:otherwise>
	...
	<xsl:template match="DateTime" name="dateTime">
		...
		<tr>
			<xsl:if test="$dt/a:Type/a:Text">
				<td>
					<xsl:value-of select="$dt/a:Type/a:Text"/>:
				</td>
			</xsl:if>
			<xsl:choose>
							...
							<xsl:otherwise>
								<td>
									...
									<xsl:if test="a:Duration">
										...
										<xsl:value-of select="a:Duration/a:Value"/>
										<xsl:text xml:space="preserve"> </xsl:text>
				...
				<tr>
					<td>
						<font color="#CCCCCC" size="3">
							<strong>Powered by the
								<a href="http://www.astm.org/cgi-bin/SoftCart.exe/DATABASE.CART/REDLINE_PAGES/E2369.htm?E+mystore"
								   style="color:#CCCCCC;">ASTM E2369-05 Specification for the Continuity of Care Record
									(CCR)
								</a>
							</strong>
						</font>
