...
Ext.define('Extensible.calendar.form.EventWindow', {
    ...
    getFormItemConfigs: function() {
        var items = [{
            ...
            xtype       : 'mitos.calcategoriescombobox',
    ...
    show: function(o, animateTarget){
        ...
        var rec, fp = this.formPanel,  f = fp.form;
        ...
        if(o.data){
             ...
             * GaiaEHR
             */
            fp.getComponent(this.id + '-patient_search').hide();    //GaiaEHR
            fp.getComponent(this.id + '-title').show();             //GaiaEHR
             ...
             * GaiaEHR
             */
            fp.getComponent(this.id + '-patient_search').show();    //GaiaEHR
            fp.getComponent(this.id + '-title').hide();             //GaiaEHR
			//this.isAdd = true;
            this.setTitle(this.titleTextAdd);
